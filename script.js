  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (field.hasAttribute('minlength')) {
        ...
        if (value.trim() !== '' && !VALIDATORS.minlength(value, min)) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Fidget toys משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'e8a60a9b-04bd-4bf3-bbfd-c8b2c080671f',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'e8a60a9b-04bd-4bf3-bbfd-c8b2c080671f';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'e8a60a9b-04bd-4bf3-bbfd-c8b2c080671f';
